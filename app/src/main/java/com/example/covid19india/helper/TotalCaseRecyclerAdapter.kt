...
import com.example.covid19india.databinding.LayoutTotalBinding
import com.example.covid19india.model.TotalCount

class TotalCaseRecyclerAdapter(private val totalCountList: ArrayList<TotalCount>): RecyclerView.Adapter<RecyclerView.ViewHolder>() {
