...
object VaccinationList {
    ...
    fun getList(covidDetails: CovidDetails): ArrayList<VaccinationCount> {
        ...
        vaccinationDetails.add(VaccinationCount(covidDetails.TT.meta.population, covidDetails.TT.total.vaccinated1, covidDetails.TT.total.vaccinated2, stateName["TT"]))
